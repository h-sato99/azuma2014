...
const TaskType TaskInit = 0;
const TaskType TaskMain = 1;
const TaskType TaskBuletooth = 2;

extern void TASKNAME( TaskInit )( void );
extern void TASKNAME( TaskMain )( void );
extern void TASKNAME( TaskBuletooth )( void );

static __STK_UNIT _stack_TaskInit[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_TaskMain[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_TaskBuletooth[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( TaskInit ), TASKNAME( TaskMain ), TASKNAME( TaskBuletooth ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_TaskInit, (__STK_UNIT)_stack_TaskMain, (__STK_UNIT)_stack_TaskBuletooth, };
...
static void _activate_alarm_cyclic_alarm2( void )
{ (void)ActivateTask( TaskBuletooth ); }
...
const TickType alminib_cycle[TNUM_ALARM] = { 4, 4, };
